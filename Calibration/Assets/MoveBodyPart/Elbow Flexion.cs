...
public class FlexElbow : MonoBehaviour
{
    ...
    void Update()
    {
        if (connectedTcpClient != null)
        {
            ...
            if (stream.DataAvailable)
            {
                ...
                RotateGameObject(armData.elbow_flexion_right);
                UpdateMinMax(armData.elbow_flexion_right);    
            }
        }
    }
    ...
    private void UpdateMinMax(float elbowFlexion)
    {
        if (elbowFlexion > max)
        {
            max = elbowFlexion;
    ...
    {
        string path = "../../game_config/elbow_flexion_ROM.json";
